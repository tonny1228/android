...
public class ZoomImageView extends View implements Observer {
    ...
    public void setImage(Bitmap bitmap) {
        ...
        mAspectQuotient.updateAspectQuotient(viewWidth, viewHeight,
                mBitmap.getWidth(), mBitmap.getHeight());
//        if (this.canvas != null) {
//            mRectSrc.left = 0;
//            mRectSrc.top = 0;
//            mRectSrc.right = viewWidth;
...
//        }
        Log.i("", "sssssssssssssssssssssssseti");
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        Log.i(",", "changeiiiiiiiiiiiiiiiiiiiiiiiii");
        if (mBitmap != null)
            mAspectQuotient.updateAspectQuotient(right - left, bottom - top,
                    mBitmap.getWidth(), mBitmap.getHeight());
        mZoomControl.zoom(0, 0, 0);
        mAspectQuotient.notifyObservers();
    }
