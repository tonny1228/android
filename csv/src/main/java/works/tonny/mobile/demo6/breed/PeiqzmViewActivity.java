...
public class PeiqzmViewActivity extends Activity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.breed_peiqzm_view);
        TitleHelper.getInstance(this).enableBack().setTitle("配犬证明申请");
    ...
    class Request extends AsyncTask<String, Integer, Map<String, Object>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            myDialog = LoadingDialog.newInstance(PeiqzmViewActivity.this);
            myDialog.show();
        }
        ...
        protected void onPostExecute(Map<String, Object> result) {
            ...
            try {
                myDialog.dismiss();
                ActivityHelper.getInstance(PeiqzmViewActivity.this).setText(R.id.pqzmh, (String) result.get("data.item.title"))
                        .setText(R.id.zt, (String) result.get("data.item.summary"))
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            if (values != null && values[0] == -1) {
                LoginActivity.startLoginActivity(PeiqzmViewActivity.this, null);
                this.cancel(true);
            }
        }
