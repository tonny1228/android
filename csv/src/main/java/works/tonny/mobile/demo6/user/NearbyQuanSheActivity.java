...
public class NearbyQuanSheActivity extends ListActivity {
    ...
    protected int getItemLayout() {
        return R.layout.user_nearbyquanshe_item;
    }

    @Override
    protected String getUrl() {
        return Application.getUrl(R.string.url_location_quanshe).replace("${latitude}", getIntent().getStringExtra("latitude"))// )
    ...
    protected AdapterView.OnItemClickListener getItemClickListener() {
...

        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = IntentUtils.newInstance(NearbyQuanSheActivity.this.getBaseContext(), NearbyQuansheViewActivity.class, item);
